...
proc import datafile="E:\1. SAS Project On Credit Card\Input files\Data.xls"
...
PROC IMPORT OUT= WORK.Customer_details
            DATAFILE= "E:\1. SAS Project On Credit Card\Input files\Customer Details.txt" 
            DBMS=TAB REPLACE;
     GETNAMES=YES;
     DATAROW=2; 
RUN;
...
proc import datafile="E:\1. SAS Project On Credit Card\Input files\Repayment.csv"
out=repayment
dbms=dlm
replace;
getnames=Yes;
...
create table defaulters as select * ,rr.amount - ss.min_sum as diff from spend_2 ss full join repay_1 rr on 
...
ods pdf file = "E:\1. SAS Project On Credit Card\bar_charts.pdf";
...
ods pdf file = "E:\1. SAS Project On Credit Card\pie_charts3d.pdf";
...
ods pdf file = "E:\1. SAS Project On Credit Card\amount_mean.pdf";
...
noheading
woutline=1
slice=arrow value=arrow percent=arrow coutline=arrow explode="&d.";
run; 
quit;
%end;
%mend a;
...
ods pdf file = "E:\1. SAS Project On Credit Card\line_graph.pdf";
...
ods pdf file = "E:\1. SAS Project On Credit Card\univariate.pdf";
...
ods pdf file = "E:\1. SAS Project On Credit Card\ryg.pdf";
...
ods pdf file = "E:\1. SAS Project On Credit Card\line_graph_cust_analysis.pdf";
PROC SGPLOT DATA = ko;    
